			...
			<div class="loginSmallDiv" id="loginSmallDiv">
				<div class="loginErrorMessageDiv">
					<div class="alert alert-danger">
						<button class="close" type="button" data-dismiss="alert" arial-label="Close"></button>
						<span class="errrorMessage"></span>
					</div>
				</div>
				...
				<div class="loginInput">
					...
					<input type="text" id="name" name="name" placeholder="手机/用户名/邮箱">
				</div>
				<div class="loginInput">
					<span class="loginInputIcon">
